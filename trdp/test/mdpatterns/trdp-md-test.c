...
void reply(const TRDP_MD_INFO_T * msg, TRDP_MSG_T type, TRDP_FLAGS_T flags);
void confirm(const TRDP_MD_INFO_T * msg, TRDP_FLAGS_T flags);
...
void setup_listeners()
{
    ...
    if (opts.groups & TST_UCAST)
    {   // UDP unicast listener
