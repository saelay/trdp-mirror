...
ifeq ($(MD_SUPPORT),1)
CFLAGS += -D__USE_BSD -D_XOPEN_SOURCE=500 -pthread -D$(TARGET_FLAG)  -fPIC -Wall -DMD_SUPPORT=1
else
CFLAGS += -D__USE_BSD -D_XOPEN_SOURCE=500 -pthread -D$(TARGET_FLAG)  -fPIC -Wall -DMD_SUPPORT=0
endif
