...
typedef enum
{
    TRDP_INAUG_INVALID = 0          /**< Ongoing inauguration, DNS not yet available, no address transformation possible
                                      */
        TRDP_INAUG_FAULT        = 1, /**< Error in train inauguration, DNS not available, trainwide communication not
                                       possible */
...
typedef struct
{
    TRDP_LABEL_T    id;             /**< Unique consist identifier (Label) / IEC identification number taken from 1st
                                      car in consist */
