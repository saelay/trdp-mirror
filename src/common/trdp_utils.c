...
/* add_end TOSHIBA */
            ...
            *pIndex = lIndex;
            ...
            if (((usage != TRDP_SOCK_MD_TCP)) || ((usage == TRDP_SOCK_MD_TCP) && (iface[lIndex].usage > -1)))
            {
                iface[lIndex].usage++;
            }
        ...
        else if (iface[lIndex].sock == -1 && emptySock == -1)
        {
    ...
    {
        if (emptySock != -1 && lIndex != emptySock)
        {
            lIndex = emptySock;
        }
        else
