...
#if (defined (WIN3) || defined (WIN64))
DWORD WINAPI testThread1(void* arguments)
#else
...
SHMEM_ERR_T L3_test_sharedMem()/*--> improve / check test!*/
{
    ...
    if (ret != VOS_NO_ERR)
    {
        vos_printLog(VOS_LOG_ERROR,"[SHMEM] vos_threadInit() ERROR\n");
...
void L1_testEvaluation(MEM_ERR_T memErr, THREAD_ERR_T threadErr, SOCK_ERR_T sockErr, SHMEM_ERR_T shMemErr, UTILS_ERR_T utilsErr)
{
    ...
    vos_printLog(VOS_LOG_ERROR," VOS_LOG_USR\n");
    ...
    vos_printLog(VOS_LOG_ERROR," SOCK_TCP_CLIENT\n");
    ...
    vos_printLog(VOS_LOG_ERROR," SHMEM\n");
    ...
    vos_printLog(VOS_LOG_ERROR," UTILS_INIT\n");
    ...
    vos_printLog(VOS_LOG_ERROR," UTILS_CRC\n");
