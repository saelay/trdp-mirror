 ...
 *
 * @author          Bernd Löhr on 11.11.11, 2011 NewTec GmbH.
 *
 ...
 * LOCAL
 */
static void callBack(void *pRefCon, const TRDP_PD_INFO_T *pMsg, UINT8 *pData, UINT32 dataSize);
    ...
    pd_receive_packet_t*    recPacket)
{
    ...
    TRDP_ERR_T err = tlp_subscribe(
                        ...
                        vos_dottedIP(recPacket->srcIP), 			/*	Source IP filter					*/
                        0,
